...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div style="max-width: 40px;"><img src="https://6477b4cfd7.imgdist.com/pub/bfra/fcnpaxdd/qdg/iu7/s6m/logo.svg" style="display: block; height: auto; border: 0; width: 100%;" width="40" alt="jobeefy" title="jobeefy" height="auto"></div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t\t\t\t\t</table>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class="pad">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div style="color:#101112;direction:ltr;font-family:Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:31px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:37.199999999999996px;">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0;"><strong>Jobeefy</strong></p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t\t\t\t\t</table>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #000000;">Dear {{name}},</span></p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #000000;">Hope this email finds you well!</span></p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t\t\t\t\t</table>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #000000;">Best regards,</span></p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #6d89bc;"><span style="word-break: break-word; color: #000000;">Elhoussaine AIT. - CEO of Jobeefy</span><br></span></p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t\t\t\t\t</table>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td style="padding:0 7px 0 7px;"><a href="https://codezeloss.vercel.app/" target="_blank"><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/circle-color/facebook@2x.png" width="32" height="auto" alt="Facebook" title="Facebook" style="display: block; height: auto; border: 0;"></a></td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td style="padding:0 7px 0 7px;"><a href="https://codezeloss.vercel.app/" target="_blank"><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/circle-color/twitter@2x.png" width="32" height="auto" alt="Twitter" title="Twitter" style="display: block; height: auto; border: 0;"></a></td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td style="padding:0 7px 0 7px;"><a href="https://codezeloss.vercel.app/" target="_blank"><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/circle-color/instagram@2x.png" width="32" height="auto" alt="Instagram" title="Instagram" style="display: block; height: auto; border: 0;"></a></td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td style="padding:0 7px 0 7px;"><a href="https://codezeloss.vercel.app/" target="_blank"><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/circle-color/linkedin@2x.png" width="32" height="auto" alt="LinkedIn" title="LinkedIn" style="display: block; height: auto; border: 0;"></a></td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</table>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
